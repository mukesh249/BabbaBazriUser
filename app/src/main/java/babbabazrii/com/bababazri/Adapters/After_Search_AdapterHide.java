...
public class After_Search_AdapterHide extends RecyclerView.Adapter<After_Search_AdapterHide.CustomViewHolder> implements Filterable{
    ...
    public After_Search_AdapterHide(ArrayList<SearchItemBinder> afterSearch_product_models_list, Context context){
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        ...
        Glide.with(holder.context.getApplicationContext())
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,OnLoadMoreListener{
        TextView aft_s_v_name,aft_s_subtype,aft_s_name,aft_s_type,aft_s_location,aft_s_price,aft_s_id;
        ...
        public CustomViewHolder(View itemView,Context context,ArrayList<SearchItemBinder> afterSearch_product_models_list_filter) {
            ...
            dfsakf = (LinearLayout)itemView.findViewById(R.id.dfsakf);
            dfsakf.setVisibility(View.GONE);
        ...
        public void ShowPriceMethod(){
            dfsakf.setVisibility(View.VISIBLE);
        }
